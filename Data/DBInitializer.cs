...
namespace WillieSandoval_2_28_2021.Data
{
    public class DBInitializer
    {
        public static void Initialize(ApplicationDbContext context)
        {
            ...
            //Delete records
            //context.Database.ExecuteSqlRaw("Delete from dbo.Companies;");
            //context.Database.ExecuteSqlRaw("Delete from dbo.Topics;");
            //context.Database.ExecuteSqlRaw("Delete from dbo.Projects;");
